...
const Plugin = (props) => {
    ...
    useEffect(() => {
        ...
        //Get Avatar
        fetch(
            `https://api.yehey.jp/frontapp/avatar`,
            {
                method: "POST",
                headers: {
    ...
    const notifyInflowSubmit = () =>
        (notifyId = toast.info("Processing..."));
                                                                    ...
                                                                    (item, index) => (
                                                                        <>
                                                                            ...
                                                                            <Input
                                                                                ...
                                                                                onChange={(e) =>
                                                                                    editAddressModal(e.target.value, index, 'postal')
                                                                                }
                                                                            />
                                                                            <Input
                                                                                className="form-control-alternative"
                                                                                ...
                                                                                onChange={(e) => editAddressModal(e.target.value, index, 'address')
                                                                                }
                                                                            />
